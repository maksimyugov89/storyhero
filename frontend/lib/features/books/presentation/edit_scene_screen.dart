...
class EditSceneScreen extends HookConsumerWidget {
  final String bookId;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> handleRegenerate() async {
      if (instructionController.text.trim().isEmpty) {
        errorMessage.value = 'Введите инструкцию для изменения изображения';
        return;
      }
      ...
      try {
        ...
        if (context.mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Сцена успешно перегенерирована'),
        ...
        errorMessage.value = 'Ошибка перегенерации: ${e.toString()}';
      } finally {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Текущее изображение
                  if (scene.finalUrl != null || scene.draftUrl != null)
                    ClipRRect(
                  ...
                  AppTextField(
                    ...
                    hint: 'Опишите, как изменить изображение...',
                  ...
                  AppMagicButton(
                    onPressed: isLoading.value ? null : handleRegenerate,
